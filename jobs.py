...
TASKS: dict[str, tuple[str, tuple[str, ...], str]] = {
    ...
    "conditions-overlap": (
        ...
        ("conditions_overlap.py",),
        "Считает по своей базе, какая доля условий от модели уже есть в структурных полях hh (график, вилка, опыт, навыки) и где модель спорит с источником. Ни сети, ни модели: это замер, а не прогон.",
    ),
    "gate-report": (
