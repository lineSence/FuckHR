...
SOURCE_FIELDS: tuple[Field, ...] = (
    ...
    Field(
        ...
        INT,
        "4",
        "Площадки обходятся параллельно друг другу и параллельно hh.ru: домены "
        "разные, и медленный API больше не держит весь сбор. Пауза считается "
        "на каждую площадку отдельно. Максимум 8.",
    ),
    Field(
        "SOURCE_MAX_PAGES",
        "Страниц на запрос",
