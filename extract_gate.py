...
MARKERS: dict[str, tuple[str, ...]] = {
    "format": (
        ...
        "пятидневк", "шестидневк", "посменн", "смена", "смены", "вахт", "неполн",
        "подработ", "сутки", "выходн", "полный день", "част зан",
    ),
    "office": (
        "офис", "адрес", "метро", "бизнес-центр", "бц ", "коворкинг", "улиц", "ул.",
        "проспект", "этаж", "территори", "площадк", "цех", "склад", "салон",
        "магазин", "клиник", "студи", "филиал", "точк", "кабинет",
    ),
    "stack": (
        "стек", "технолог", "фреймворк", "framework", "python", "java", "sql", "linux",
        "docker", "1с", "1c", "excel", "битрикс", "api", "git", "php", "c#", "javascript",
        "golang", "react", "vue", "node", "typescript", "kubernetes", "postgres",
        "mysql", "mongo", "redis", "kafka", "kotlin", "swift", "ruby", "scala", ".net",
        "c++", "разработк", "фигма", "figma", "crm", "erp", "sap",
    ),
    "process": (
        "собеседован", "интервью", "этап", "тестово", "отбор", "скрининг", "оффер",
        "знакомств", "анкет", "резюме", "испытательн", "процесс", "тестирован",
        "релиз", "спринт", "постановк задач",
    ),
    "other": (
        ...
        "трудоустройств", "карьер", "график отпуск", "стажир", "нейросет",
        "ai-", "инструмент",
    ),
}
