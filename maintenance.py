...
TARGETS: tuple[tuple[str, str, tuple[str, ...], str, bool], ...] = (
    ...
    (
        ...
        ("vacancy_conditions", "hr_signals", "vacancy_sources", "vacancies"),
        "Собирается заново за один прогон. История публикаций остаётся нетронутой. "
        "Вместе с вакансиями уходит разметка площадок, а значит и метрика «только "
        "здесь»: она начнёт набираться снова.",
        False,
    ),
    (
        "score",
